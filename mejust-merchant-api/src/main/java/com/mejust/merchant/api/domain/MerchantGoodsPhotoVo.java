...
public class MerchantGoodsPhotoVo {
    /**
     * 商品编码
     */
     ...
     * 图片6名称
     */
    @ApiModelProperty(value = "图片6名称")
    private String photo6;

    /**
     * 图片6地址
     */
    @ApiModelProperty(value = "图片6地址")
